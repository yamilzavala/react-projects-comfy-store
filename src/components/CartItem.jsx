...
import { removeItem, editItem } from '../store/features/cart/cartSlice';
...
const CartItem = ({cartItem}) => {
    ...
    const {cartID, image, title, price, amount, productColor, company} = cartItem;
        ...
        <article key={cartID} className='mb-12 flex flex-col gap-y-4 sm:flex-row flex-wrap border-b border-base-300 pb-6 last:border-b-0'>
           ...
           <div className='sm:ml-12'>
                ...
                <div className='form-control max-w-xs'>
                    ...
                    <select name='amount' id="amount" value={amount} onChange={handleAmount} className='label-text'>
